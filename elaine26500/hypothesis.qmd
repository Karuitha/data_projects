...
In this project, we analyse data from [Kaggle](https://www.kaggle.com/datasets/samira1992/student-scores-simple-dataset) that consists of maths scores and the hours of study [^1].

[^1]: The data is available on this link, https://www.kaggle.com/datasets/samira1992/student-scores-simple-dataset
...
The data is available on [this link](http://roycekimmons.com/tools/generated_data/exams). I pick the data that has 1000 observations [^2].

[^2]: See the data source here, http://roycekimmons.com/tools/generated_data/exams
