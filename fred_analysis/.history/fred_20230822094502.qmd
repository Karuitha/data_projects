...
Now let us get the data on the net issues of international debt securities by the government of Kenya. This is the last item in our search list. In downloading the data, we provide python with the serach id which is `IDSOFAMRINIKE` in this case.
...
As an alternative, lt us look at the Kenya shilling-US Dollar exchange rate. 
...
```{python}
exchange.plot(title = "Kenya Shilling US Dollar Exchange Rate 1950-2022", ylabel = "Exchange Rate", color = "red")
