...
Next, we shift oir attention to our data source: FRED. FRED database is owned and maintained by the federal reserve bank of St. Louis in the United States. The database contains a vast array of economic variables from countries across the globe. 
