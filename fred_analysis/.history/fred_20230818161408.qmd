...
I load the data from the FRED api. To start downloading data, you have to request for an `api` key from FRED by creating an account. From your account, you can then get an api key.
