...
arrival_tsb %>% as_tibble() |> class()#this converts a tsibble to a tibble
```
...
write_rds("data/arrival_daily.rds",arrival_daily)
```
...
weekly_arrivals <- arrival_hourly %>% 
...
monthly_arrivals <- arrival_hourly %>% 
