...
1. Extract time series features (i.e. numerical summary) for a given time series
2. Visualise time series features for many time series
3. Use dimensional reduction techniques to understand data 
