...
```{python}
africa[africa["stock_exchange"] != "South Africa"][["name", "stock_exchange"]].head(20).value_counts().plot(kind = "pie", title = "Domicile of Top 20 Companies in Africa (Outside South Africa)", autopct = "%1.0f%%")
```
