...
- Market_value_2023: The company market value in 2023.
...
```{python}
africa["ranking2022"] = pd.to_numeric(africa["ranking2022"])
africa["market_value_22"] = pd.to_numeric(africa["market_value_22"])
