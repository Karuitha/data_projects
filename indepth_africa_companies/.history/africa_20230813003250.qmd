...
4. What is the correlation between market value of a company on the one hand and revenues and profits on the other?
...
```{python}
africa = pd.read_excel("africa250.xlsx").sort_values(by = "ranking 2023")
