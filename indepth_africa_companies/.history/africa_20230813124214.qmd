...
5. The top 250 companies operate in telecommunications, non-energy materials, and finance sectors.
6. Revenues have a higher correlation with company value compared to profits.
...
"revenue_latest", "net_income_latest"]], hue = "stock_exchange", palette = "colorblind", corner = True, dropna = True)
```
...
Outside South Africa, the top companies in Africa are MTN Nigeria followed by Dangote cement. Safarocom of Kenya is sixth in the list and 24th in the top 250 companies in Africa.
