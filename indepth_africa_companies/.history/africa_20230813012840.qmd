...
```{python}
africa[africa["stock_exchange"] != "South Africa"][["name", "stock_exchange"]].head(20).value_counts()["stock_exchange"].plot(kind = "pie", title = "Domicile of Top 20 Companies in Africa (Outside South Africa)", autopct = "%1.0f%%")
```
...
## Which companies have the best financial performance in 2022 and 2023?
