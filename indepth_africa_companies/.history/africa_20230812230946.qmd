...
# Data
I scrape the data using Libreoffice calc. Libreoffice calc is the equivalent of Ms Excel except that it is free to use. Next, I load the required python packages and read in the data. 
```{python}
import pandas as pd
