...
## Which are the top ranking companies in Africa in 2022 and 2023?
...
Notable is that most of the companies in the top 20 are from South Africa. 

```{python}
africa[["name","sector","stock_exchange",
"market_value_22","market_value23",
"revenue_latest", "net_income_latest"]].head(20)["stock_exchange"].value_counts().plot(kind = "pie", title = "Domicile of Top 20 Companies in Africa")
```
