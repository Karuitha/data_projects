...
Python has captured the variables ranking2022 and market_value_2022 as text rather than numeric values. To correct this anomaly, we convert these variables to the appropriate data format. Likewise  the country Botswana is also written in all upper case BOTSWANA. 
