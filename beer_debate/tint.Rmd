...
As noted before, each beer falls into a particular category represented by the variable `type` in the data set. The box plot below shows the variability in alcohol concentration for each beer type. 
