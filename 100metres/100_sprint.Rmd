...
As noted, the data is available on the World Athletics website. This data spans two hundred and twenty-four (224) web pages at this write-up. Tellingly, it would take ages to copy-paste this data. Hence, the first exercise is to scrap the data. Please refer to my previous project on [web scrapping](https://rpubs.com/Karuitha/web_scrapping_1) available on <https://rpubs.com/Karuitha/web_scrapping_1>. I outline the steps in scrapping the data next. 
...
It is common knowledge that Usain Bolt is the record holder. Usain Bolt holds four of the ten best times in the dash. But who are the other top contenders? I remove duplicates so that we have one entry per athlete. With that, the top 10 athletes are in table () below. 
