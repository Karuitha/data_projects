...
pacman::p_load(tidyverse, janitor, skimr, GGally, 
               ...
               htmltools, jtools, huxtable, officer)
...
```{r}
motiv_pca <- my_data %>% 
    dplyr::select(starts_with(c("motiv"))) %>% 
...
Lastly, first principal component for technology contributes 52% of the total variability.
...
The graphs below shows the contributions of each principal component to the total variability.
...
plot(motiv_pca, type = "l", main = "Principal Component Analysis, Motivation")

plot(js_pca, type = "l", main = "Principal Component Analysis, Satisfaction")


plot(wfh_pca, type = "l", main = "Principal Component Analysis, Remote Work")

plot(tech_pca, type = "l", main = "Principal Component Analysis, Technology")
...
\newpage
```
#### Visualizing the First Principal Components
