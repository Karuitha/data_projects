...
us_prisons_data %>% 
        ...
        ggplot(mapping = aes(x = race, y = prop, col = pop_variables)) + 
        
        geom_point(size = 20, shape = 1, stroke = 10, show.legend = FALSE) + 
        
        ggthemes::theme_clean() + 
        
        geom_text(mapping = aes(label = pop_variables, label = pop_variables),
